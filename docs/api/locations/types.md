...
Return distinct location type values for the project's assigned Stylebook. Use this to populate filter dropdowns before calling [List and search](search.md) or [Geographic search](geo-search.md).
