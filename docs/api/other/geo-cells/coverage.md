...
Return H3 hex cells with distinct-article counts for location mentions inside a bounding box. Use this to build zoomable coverage maps — each cell shows how many unique articles mention places in that area.
