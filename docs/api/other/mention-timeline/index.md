...
Mention timeline endpoints return mention counts grouped by article publication date for one canonical person, organization, or location. Use them to chart how often an entity appears in coverage over time without paginating through individual mention rows.
