...
Item rows omit `entity_type`, `canonical`, and internal entity ids — the route is already scoped to one person.
...
- [List articles](list-articles.md) — deduplicated story feed for this person
