...
A **run** is what happens when you execute a [flow](flows.md) on your text. A single run can process one article or a whole batch — for example, a folder of files pulled from cloud storage.
...
!!! note "Coming soon"
    ...
    - Estimated AI cost for a run and its individual steps
