...
- What Person Extract and Place Extract produce.
...
Complete [Build your first flow](build-flow.md) or open a flow with Text or JSON
Input and an output node. Enable a compatible generative model.

## Planned walkthrough

1. Add Person Extract and Place Extract on parallel branches.
...
5. Run a Minnesota sample article containing names, quotes, and known places.
